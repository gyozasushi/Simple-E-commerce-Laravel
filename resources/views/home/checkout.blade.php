                ...
                <form name="checkout" class="checkout ecommerce-checkout row" method="POST" action="/payments">
                    ...
                    <div class="col-md-4">
                        <div class="order-review-wrap ecommerce-checkout-review-order" id="order_review">
                            <h2 class="heading uppercase bottom-line full-grey">Order Kamu</h2>
                            ...
                            <div id="payment" class="ecommerce-checkout-payment">
                                ...
                                <ul class="payment_methods methods">
                                    ...
                                    <li class="payment_method_bacs">
                                        ...
                                        <label for="payment_method_bacs">Bank Transfer Manual</label>
                                        <div class="payment_box payment_method_bacs">
                                            <p>Lakukan pembayaran langsung ke rekening bank kami. Harap gunakan ID Pemesanan Anda sebagai referensi pembayaran. Pesanan Anda tidak akan dikirimkan sampai dana tersebut telah tersedia di rekening kami.</p>
                                            <p>Atas Nama : Dennis Abizar</p>
                                            <p>No Rekening : 0862-01-008667-50-1</p>
                                            <p>Bank : BRI</p>
                                        </div>
                                    </li>
                                </ul>
