...
<body>
    <div class="flex py-7 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
        <div class="flex shadow flex-col-reverse lg:flex-row">
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                ...
                <p class="text-gray-600">Isi Formulir Untuk Registrasi </p>
                <br>
                ...
                <span>punya akun? <a href="/login_member" class="text-blue-400 hover:text-blue-600"> Login
                        disini.</a></span>
            </div>
