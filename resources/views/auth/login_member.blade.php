        ...
        <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
            ...
            <form action="/login_member" method="POST" class="mt-10">
                ...
                <div class="my-3">
                    ...
                    <input type="text" placeholder="alamat@email.com" name="email" id="email"
            ...
            <div>login sebagai admin <a href="/login" class="text-blue-400 hover:text-blue-600">Login.</a></div>
        </div>
        <div class="w-full lg:w-1/2 flex justify-center items-center">
            <img src="/assets/logo.png" alt="Login Image" class="w-full">
        </div>
    </div>
</div>
